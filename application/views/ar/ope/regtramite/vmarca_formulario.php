<div class="modal fade" id="modalFormularioMarca"
	...
	<div class="modal-dialog modal-xl modal-dialog-scrollable">
		<div class="modal-content">
			...
			<div class="modal-body"
				...
				<form action="<?php echo base_url('ar/ope/cmarcaxcliente/guardar') ?>" method="POST"
					  accept-charset="UTF-8" id="frmMarca" >
					<div class="form-group row">
						<label for="marca_cliente_text" class="col-xl-2 col-lg-2 col-md-4 col-sm-12 col-12">
							Cliente
						</label>
					...
					<div class="row">
						<div class="col-xl-4 col-lg-5 col-md-12 col-sm-12 col-12">
							<div class="form-group row">
								<label for="marca_estado" class="col-xl-6 col-lg-5 col-md-4 col-sm-12 col-12">
									Estado
									<span class="fs-requerido text-danger">*</span>
								</label>
								<div class="col-xl-6 col-lg-7 col-md-8 col-sm-12 col-12">
									<select class="custom-select" aria-label=""
											id="marca_estado" name="marca_estado" >
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-danger" id="btnGuardarMarca" >
