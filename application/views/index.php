...
<!-- ChartJS -->
<script src="<?php echo public_url(); ?>template/GUI/plugins/chart.js/Chart.min.js"></script>
<!-- Sparkline -->
<script src="<?php echo public_url(); ?>template/GUI/plugins/sparklines/sparkline.js"></script>
<!-- JQVMap -->
<script src="<?php echo public_url(); ?>template/GUI/plugins/jqvmap/jquery.vmap.min.js"></script>
<script src="<?php echo public_url(); ?>template/GUI/plugins/jqvmap/maps/jquery.vmap.usa.js"></script>
<!-- jQuery Knob Chart -->
<script src="<?php echo public_url(); ?>template/GUI/plugins/jquery-knob/jquery.knob.min.js"></script>
<!-- daterangepicker -->
...
<script src="<?php echo public_url(); ?>template/GUI/dist/js/pages/dashboard.js"></script>
