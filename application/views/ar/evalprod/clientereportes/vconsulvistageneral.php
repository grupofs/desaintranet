            ...
            <div class="card-body">
                ...
                <div class="row">    
                  <div class="col-md-6">
                      ...
                      <textarea type="text" name="mtxtEANmultiple" id="mtxtEANmultiple" class="form-control" rows="2" cols="40"></textarea> 
                  </div>  
                  <div class="col-md-6">
                      <label>SKU Multiple </label>
                      <textarea type="text" name="mtxtSKUmultiple" id="mtxtSKUmultiple" class="form-control" rows="2" cols="40"></textarea> 
                  </div>
                </div>  
            </div>             
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer justify-content-between" style="background-color: #D4EAFC;">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-right">                        
                      <button type="reset" class="btn btn-default" id="mbtnCerrarModalSKU" data-dismiss="modal">Cancelar</button>
