			...
			foreach($resultado as $row){
				...
				$html .= '<div class="teacherPage">				
					...
					<tbody>
						...
						<tr>
							<td class="cuerpo">
								<p>Me dirijo a usted para saludarle y en el marco del Programa de vigilancia y control de proveedores de '.$cliente_drazonsocial.', comunicarle que el establecimiento <b>'.$establecimiento.'</b> será inspeccionado en el transcurso del mes de <b>'.$mes.' - 2020</b>, por un inspector calificado de la empresa '.$drazonsocial.'.</p>
