...
recuperaListproducto = function(){
    otblListProducto = $('#tblListProductos').DataTable({  
        ...
        'columns'	: [
            ...
            {"orderable": false, data: 'stottus', targets: 2},
            {"orderable": false, data: 'cmuestra', targets: 3},
            {"orderable": false, data: 'ntrimestre', targets: 4},
            {"orderable": false, data: 'zctipomotivo', targets: 5},
            {"orderable": false, data: 'careacliente', targets: 6},
            {"orderable": false, data: 'dubicacion', targets: 7},
            {"orderable": false, data: 'zctipoitem', targets: 8},
            {"orderable": false, data: 'drealproducto', targets: 9},
            {"orderable": false, data: 'dpresentacion', targets: 10},
            {"orderable": false, data: 'dtemperatura', targets: 11},
            {"orderable": false, data: 'dcantidad', targets: 12},
            {"orderable": false, data: 'dproveedorproducto', targets: 13},
            {"orderable": false, data: 'dlote', targets: 14},
            {"orderable": false, data: 'fenvase', targets: 15},
            {"orderable": false, data: 'produccion', targets: 16},
            {"orderable": false, data: 'fvencimiento', targets: 17},
            {"orderable": false, data: 'fingresoaccion', targets: 18},
            {"orderable": false, data: 'dtempproducto', targets: 19},
            {"orderable": false, data: 'dtempalmacenamiento', targets: 20},
            {"orderable": false, data: 'fmuestra', targets: 21},
            {"orderable": false, data: 'hmuestra', targets: 22},
            {"orderable": false, data: 'dcondicion', targets: 23},
            {"orderable": false, data: 'dobservacion', targets: 24},
            {"orderable": false, data: 'dotraobservacion', targets: 25},
