...
class Cgendoccapa extends CI_Controller {
	function __construct() {
		parent:: __construct();	
		$this->load->model('at/capa/mgendoccapa');
  ...
  */  
	...
	public function pdfcertiEmpApro($idcapa) { // recupera los cartas a proveedores
        ...
        <head>
            <style>
                ...
                table.tprincipal tr td{
                    width: 100%;
                }
                table.tprincipal tr.trcuerpo td div{
                    height: 360px;
                    max-height: 360px;
                    overflow: visible;
                }
                table.tprincipal tr.trfirma td div{
                    height: 100px;
                    max-height: 100px;
                    overflow: visible;
                    
                }
                table.tprincipal tr.trpie td div{
                    height: 30px;
                    max-height: 30px;
                    overflow: visible;
                }
            ...
            <main>                 
                <table class="tprincipal" align="center">
                    <tr class="trcuerpo">
                        <td>
                            <div>
                            <table class="tblcuerpo">
                                <tr>
                                    <td>Otorgado a la empresa</td>
                                </tr>  
                                <tr>
                                    <td><b><br>EMPRESA</b></td>
                                </tr>  
                                <tr>
                                    <td><br>Por la aprobación del personal en el curso:</td>
                                </tr>  
                                <tr>
                                    <td><b>CURSO</b></td>
                                </tr>  
                                <tr>
                                    <td>realizado los días DIAS, con una duración</td>
                                </tr>  
                                <tr>
                        ...
                        <td>
                            ...
                            <table class="tbllistado">
                                <tr>
                                    <td colspan="2" align="center">Relación de Participantes Aprobados</td>
                                </tr>   
                                <tr class="trlistado" align="left">
                                    <td>Participante 01<br>Participante 02<br>Participante 03<br>Participante 04<br>Participante 02<br>Participante 03<br>Participante 04</td>
                                    <td>Participante 10<br>Participante 12</td>
                                </tr>   
                            </table>                            
                            </div>
                        </td>
                    ...
                    <tr class="trfirma">
                        <td>
                            <div>
                            <table class="tblfirma" align="center">
                                <tr>
                                    <td>Blga. Sonia Palomino Salcedo</td>
                                </tr>
                                <tr>
                    ...
                    <tr class="trpie">                        
                        <td><div style="text-align: left;">Surxo, 20 de mayo de 2013</div></td>
                        <td><div style="font-size: 9pt; text-align: right;">CERT.N°:438/AL/FS/CAP-2013</div></td>
                    </tr>  
	...
	public function pdfcertiEmpParti($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiEmpAproNota($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiEmpAproDni($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiEmpAproNotadni($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiEmpPartiDni($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivProgApro($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivProgParti($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivProgAproNota($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivProgAproDni($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivProgAproNotaDni($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivProgPartiDni($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivCurApro($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivCurParti($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivCurAproNota($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivCurAproDni($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivCurAproNotaDni($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
	...
	public function pdfcertiIndivCurPartiDni($idcapa) { // recupera los cartas a proveedores
		$this->load->library('pdfgenerator');
		$filename = "Document_name";
