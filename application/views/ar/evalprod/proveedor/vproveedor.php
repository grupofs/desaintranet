...
$s_tipousu = $this->session->userdata('s_tipousu');
?>
				...
				<div class="card-body">
					<form class="form-horizontal" id="frmBuscarTramite">
						...
						<input name="idcia" type="hidden" id="idcia"
							   value="<?php echo $cia ?>">
						<input name="tipo_usuario" type="hidden" id="tipo_usuario"
							   value="<?php echo $s_tipousu ?>">
						<div class="row">
					...
					<div class="row" >
						<div class="col-md-4 col-12" >
							<button type="button" class="btn btn-success" id="btnDownload">
								<i class="fa fa-download" ></i> Descargar Resultado
							</button>
						</div>
