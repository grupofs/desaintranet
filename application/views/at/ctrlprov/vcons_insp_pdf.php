...
<page backtop="30mm" backbottom="5mm" backleft="10mm" backright="10mm" style="font-size: 12pt">
	<page_header>
		<div class="col-12">
			<table class="table">
				<tr>
...
<!--				</tr>-->
	...
	<div class="col-12">
		...
		<div class="text-left text-justify" style="width: 675px;" >
		...
		<?php if (!empty($peligros)) { ?>
			...
			<?php } ?>
		<?php } ?>
		<h3>VIII. PLAN DE ACCIONES CORRECTIVAS</h3>
		<div class="text-justify" style="width: 675px" >
